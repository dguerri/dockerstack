...
#NOVA_SERVICE_PASS
NOVA_GLANCE_HOST=${NOVA_GLANCE_HOST:-127.0.0.1}
NEUTRON_AUTH_URL=${NEUTRON_AUTH_URL:-http://127.0.0.1:35357}
...
sed -i "s#%NOVA_GLANCE_HOST%#${NOVA_GLANCE_HOST}#" "$CONFIG_FILE"
sed -i "s#%NEUTRON_AUTH_URL%#${NEUTRON_AUTH_URL}#" "$CONFIG_FILE"
