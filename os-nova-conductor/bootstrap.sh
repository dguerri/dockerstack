...
#NOVA_SERVICE_PASS
NOVA_GLANCE_API_HOST=${NOVA_GLANCE_API_HOST:-127.0.0.1}
NOVA_NEUTRON_SERVER_HOST=${NOVA_NEUTRON_SERVER_HOST:-http://127.0.0.1:9696}
...
sed -i "s#%NOVA_GLANCE_API_HOST%#${NOVA_GLANCE_API_HOST}#" "$CONFIG_FILE"
sed -i "s#%NOVA_NEUTRON_SERVER_HOST%#${NOVA_NEUTRON_SERVER_HOST}#" \
    "$CONFIG_FILE"
