...
IRONIC_GLANCE_HOST="${IRONIC_GLANCE_HOST:-localhost}"
...
#IRONIC_SERVICE_PASS
IRONIC_NEUTRON_SERVER_HOST="${IRONIC_NEUTRON_SERVER_HOST:-127.0.0.1}"
...
sed -i "s#%IRONIC_GLANCE_HOST%#${IRONIC_GLANCE_HOST}#" "$CONFIG_FILE"
...
sed -i "s#%IRONIC_NEUTRON_SERVER_HOST%#${IRONIC_NEUTRON_SERVER_HOST}#" \
    "$CONFIG_FILE"
